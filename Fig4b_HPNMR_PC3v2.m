...
for gn=1:NGrp
    for dn= 2%1:NSamp
        ...
        %------------
        nexttile
        f4b2h=plot(kplvec,residvec,'-',kpll,thresh,'r>','linewidth',2,'MarkerSize',14);
        set(gca,'fontsize',12)
        %hold on
        ...
        exportgraphics(gcf,sprintf('Fig4b-NMR-%s.png',Group.Name),'Resolution',352); % default res 150
