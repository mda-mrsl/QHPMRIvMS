...
nexttile
f3c1h=plot(fdv.taxis,fdv.data(3,:),'gx',...
...
%text(kplest-0.06,resnatest+max(residvec)/6,...
...
print(sprintf('Fig2c-MS-%s',tumor{tflag}),'-depsc')
exportgraphics(gcf,sprintf('Fig2c-MS-%s.png',tumor{tflag}))
