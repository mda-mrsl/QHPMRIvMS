...
ofn1pc=fullfile('data',sprintf('%s.%d%02d%02d.mat','HPMRIPK_post_1PC',dtt.Year,dtt.Month,dtt.Day));
...
ofn2pc=fullfile('data',sprintf('%s.%d%02d%02d.mat','HPMRIPK_post_2PC',dtt.Year,dtt.Month,dtt.Day));
...
ofn3pc=fullfile('data',sprintf('%s.%d%02d%02d.mat','HPMRIPK_post_3PC',dtt.Year,dtt.Month,dtt.Day));
            ...
            for kk=1:NSL
                if tmpmask(ii,jj,kk)
                    ...
                    for kplvi=1:kplveclen
                        ...
                        maxpyrsig=max(squeeze(spyr(ii,jj,kk,:)));
