function [Mxyev, Mxyiv, vols, Mzev, Mziv] = P2LCMSv4NoLe2(vars,fdv)
...
%     end
    ...
    a24 = kecldve;
    a31 = kecpdvc;
    a33 = -(kecpdvc+x.kpl+(x.kpx));
    a34 = x.klp;
    a42 = kecldvc;
    a43 = x.kpl;
    a44 = -(kecldvc+x.klp+(x.klx));
...
Mxyev(1:2,:)=Mxyev(1:2,:)*x.VIFScale;
Mzev(1:2,:)=Mzev(1:2,:)*x.VIFScale;
%Note VIFScale here is used as a scaling factor between the mass
% (1) of cells through time, and (2) of media at t=60s
% that was assessed by mass spec.
