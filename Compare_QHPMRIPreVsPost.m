...
infn1='QHPMRIPre.mat';      % Generated by "Fig7_BaselineV3.m"
infn2='QHPMRIPost.mat';     % Generated by "Fig7_Postv3.m"
...
effect_size_nlac=abs(mean(nLac1(nlacmask1))-mean(nLac(nlacmask)))/sqrt((std(nLac1(nlacmask1))^2+std(nLac(nlacmask))^2)/2)
% effect_size_nlac = 0.2915
...
%Calculate effect size: Cohen's d with pooled standard deviation:
effect_size_aucr=abs(mean(AUCr1)-mean(AUCr2))/sqrt((std(AUCr1)^2+std(AUCr2)^2)/2)
% effect_size_aucr = 0.4047
...
%Calculate effect size: Cohen's d with pooled standard deviation:
effect_size_kpla=abs(mean(kpla1(kplamask1))-mean(kpla(kplamask)))/sqrt((std(kpla1(kplamask1))^2+std(kpla(kplamask))^2)/2)
% effect_size_kpla = 0.6696
...
%Calculate effect size: Cohen's d with pooled standard deviation:
effect_size_kplb=abs(mean(kplb1(kplbmask1))-mean(kplb2(kplbmask2)))/sqrt((std(kplb1(kplbmask1))^2+std(kplb2(kplbmask2))^2)/2)
% effect_size_kplb = 0.1355
...
%Calculate effect size: Cohen's d with pooled standard deviation:
effect_size_kplc=abs(mean(kplc1(kplcmask1))-mean(kplc2(kplcmask2)))/sqrt((std(kplc1(kplcmask1))^2+std(kplc2(kplcmask2))^2)/2)
% effect_size_kplc = 0.5305
...
% rspvbb = 0.2747
esvbb=abs(mean(vbb1(kplbmask1))-mean(vbb2(kplbmask2)))/sqrt((std(vbb1(kplbmask1))^2+std(vbb2(kplbmask2))^2)/2)
% esvbb = 0.2378
...
% p=0.0088 **
eskveb=abs(mean(kveb1(kplbmask1))-mean(kveb2(kplbmask2)))/sqrt((std(kveb1(kplbmask1))^2+std(kveb2(kplbmask2))^2)/2)
% eskveb = 0.6011
...
% p=0.5877
esvbc=abs(mean(vbc1(kplcmask1))-mean(vbc2(kplcmask2)))/sqrt((std(vbc1(kplcmask1))^2+std(vbc2(kplcmask2))^2)/2)
% esvbc = 0.1186
...
% p=0.0234 *
eskvec=abs(mean(kvec1(kplcmask1))-mean(kvec2(kplcmask2)))/sqrt((std(kvec1(kplcmask1))^2+std(kvec2(kplcmask2))^2)/2)
% eskvec = 0.6145
...
% p<<0.001 **
esdcevb=abs(mean(dcevb1(dcemask1))-mean(dcevb2(dcemask2)))/sqrt((std(dcevb1(dcemask1))^2+std(dcevb2(dcemask2))^2)/2)
% esdcevb = 0.7280
...
% p<<0.001 **
esdcektrans=abs(mean(ktrans1(dcemask1))-mean(ktrans2(dcemask2)))/sqrt((std(ktrans1(dcemask1))^2+std(ktrans2(dcemask2))^2)/2)
% esdcektrans = 2.5451
